...
public class NexmarkSourceOptions {
	 ...
	 * @see NexmarkConfiguration#numEvents
	 */
	public static final ConfigOption<Boolean> RANDOM_IMPROVED = ConfigOptions
			.key("random.improved")
			.booleanType()
			.defaultValue(false);
	...
	public static NexmarkConfiguration convertToNexmarkConfiguration(ReadableConfig config) {
		...
		nexmarkConf.randomAlgorithm = config.get(RANDOM_ALGORITHM);
		nexmarkConf.randomImproved = config.get(RANDOM_IMPROVED);
